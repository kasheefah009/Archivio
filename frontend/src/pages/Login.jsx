...
const TextCard = ({ eyebrow, title, tall }) => (
    <div
...
const col1 = [
    <ImgCard key="1a" src={Archivio8} alt="Modern house exterior" h={340} />,
    <ImgCard key="1b" src={Archivio7} alt="Interior hallway" h={420} />,
    <TextCard key="1c" eyebrow="Wabi-sabi" title="A study of form and natural light." />,
    <ImgCard key="1d" src={Archivio6} alt="Concrete facade" h={300} />,
];

const col2 = [
    <ImgCard key="2a" src={Archivio5} alt="Floor plan sketch" h={280} />,
    <TextCard key="2b" eyebrow="Courtyard living" title="Privacy, light, connection." tall />,
    <ImgCard key="2c" src={Archivio4} alt="Dining room table" h={380} />,
    <ImgCard key="2d" src={Archivio3} alt="Stone fireplace" h={260} />,
];

const col3 = [
    <ImgCard key="3a" src={Archivio2} alt="Architectural rendering" h={320} />,
    <PaletteCard key="3b" />,
    <ImgCard key="3c" src={Archivio1} alt="Reading nook" h={340} />,
    <TextCard key="3d" eyebrow="Philosophy" title="Timeless spaces, thoughtful design." tall />,
];
                ...
                <div className="flex items-center justify-center px-6 py-16 sm:px-12 lg:px-20">
                    <div className="w-full max-w-md">
                        ...
                        <p className="mt-5 max-w-sm text-[15px] leading-relaxed text-stone-400">
                            Log in to continue discovering inspiring architecture, saving
                            ideas, and planning your dream spaces.
                        </p>

                        <form method="POST" onSubmit={handleSubmit} noValidate className="mt-9 space-y-5">
                            <div>
                            ...
                            <div className="flex items-center justify-between pt-1">
                                <label className="flex cursor-pointer items-center gap-2 text-sm text-stone-300">
                                    <input
                                        ...
                                        className="h-4 w-4 rounded border-stone-600 bg-transparent text-orange-600 accent-orange-600"
                                    />
                                    Remember me
                                </label>
                                <Link to="/forgot-password" className="text-sm font-medium text-orange-500 hover:text-orange-400">
                                    Forgot password?
                                </Link>
                            </div>
